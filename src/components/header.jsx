...
export default function Header({ username = "guilhermeteixeira01", repo = "AimAssist" }) {
    ...
    useEffect(() => {
        if (!isDarkMode) {
            document.documentElement.style.setProperty('--primary-color', '#cfcfcf 0%');
            document.documentElement.style.setProperty('--secondary-color', '#090a0f 100%');
            document.documentElement.style.setProperty('--text-color', '#090a0f');
            document.documentElement.style.setProperty('--text-color-secondary', '#202020');
            document.documentElement.style.setProperty('--green-text', '#00ff5e');
        } else {
            document.documentElement.style.setProperty('--primary-color', '#050510 0%');
            document.documentElement.style.setProperty('--secondary-color', '#000 100%');
            document.documentElement.style.setProperty('--text-color', 'snow');
            document.documentElement.style.setProperty('--text-color-secondary', '#9ca3af');
            document.documentElement.style.setProperty('--green-text', '#22c55e');
        }
    }, [isDarkMode]);
        ...
        <>
            <header className={menuOpen ? "active" : ""}>
                <div className="logodiv">
                    <h1 className="Title" data-aos="flip-left">Aim Assist</h1>
                </div>
